...
/*
  ...
  Description: Convert your wordpress site/blog in to a mobile app Woocommerce & Buddypress. 
  Version:1.6
  ...
  function __construct()
	{
	  ...
	  add_filter( 'init', array( $orgPlugins, 'WordApp_change_theme_root' ) );
		 /*- WP REST API -*/
